# this repository includes the informamtion about sql with python as it is achieved from SQL for Data Science course offered by IBM and enrolled through homem.edx.org
